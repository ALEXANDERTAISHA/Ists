...
<section class="visit-page-header">
    <div class="container text-center">
        <h1 class="visit-page-title">Bienestar Institucional</h1>
    </div>
</section>
    ...
    <div class="container">
        <div class="visit-box">
            <div class="visit-text-content">
                ...
                <p>
                    El Departamento de Bienestar Institucional promueve el desarrollo integral de la 
                    comunidad educativa, brindando servicios de apoyo estudiantil, salud, cultura, 
                    deporte y asistencia social para mejorar la calidad de vida institucional.
                </p>

                <h3 class="section-subtitle">Funciones Principales</h3>
                <ul class="feature-list">
                    <li>Gestión de becas y ayudas estudiantiles</li>
                    <li>Atención médica y primeros auxilios</li>
                    <li>Apoyo psicológico y orientación vocacional</li>
                    <li>Programas deportivos y recreativos</li>
                    <li>Actividades culturales y artísticas</li>
                    <li>Servicio de comedor estudiantil</li>
                    <li>Programas de inclusión y accesibilidad</li>
                </ul>
                ...
                <div class="contact-info">
                    ...
                    <p><strong>Ubicación:</strong> Edificio de Servicios Estudiantiles</p>
                    <p><strong>Teléfono:</strong> (07) 274-0XXX ext. 103</p>
                    <p><strong>Email:</strong> bienestar@istssucua.edu.ec</p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\public\visitar\bienestar-institucional.blade.php ENDPATH**/ ?>