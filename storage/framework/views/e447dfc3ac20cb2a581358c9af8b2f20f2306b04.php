    ...
    <div class="container rector-container">
        <div class="rector-inner">
            ...
            <div class="rector-image">
                ...
                ?>
                <img src="<?php echo e($imgSrc); ?>" alt="Rector" />
            </div>
            <?php endif; ?>
            <div class="rector-content">
                ...
                <div class="rector-excerpt"><?php echo Str::limit($firstParagraph, 400); ?></div>
        ...
        <div class="rector-modal-content">
            ...
            <div class="rector-modal-body">
                <?php if($rector->image_path): ?>
                    <img src="<?php echo e(asset('storage/' . $rector->image_path)); ?>" alt="Rector" style="max-width:200px;margin-bottom:10px;">
                <?php endif; ?>
                <h3><?php echo e($rector->name); ?></h3>
                ...
                <div id="rector-paragraph-all" style="display:none;margin-top:10px;">
                    <div class="rector-full-message"><?php echo $rector->message ?? ''; ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\workspace\ists\resources\views\public\partials\rector.blade.php ENDPATH**/ ?>