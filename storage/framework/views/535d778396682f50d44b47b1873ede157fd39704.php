...
<?php $__env->startSection('title', 'Administración de Menú - ISTS Admin'); ?>
...
<div class="container-fluid px-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4" style="gap: 0.8rem;">
        ...
        <a href="<?php echo e(route('admin.menu-items.create')); ?>" class="btn" style="background:linear-gradient(135deg,#0ea5a4,#2563eb); color:#fff; font-weight:700; border-radius:12px; padding:0.65rem 1rem; box-shadow:0 8px 20px rgba(37,99,235,0.18);">
            ...
            <div class="card h-100" style="border:1px solid #dbe7f7; border-radius:16px; box-shadow:0 10px 24px rgba(15,23,42,0.08);">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3 text-center" style="background:#f8fafc; border:1px dashed #cbd5e1; border-radius:12px; padding:1rem;">
                        <img src="<?php echo e($logoUrl); ?>" alt="Logo actual del header" style="max-height:78px; width:auto; max-width:100%; object-fit:contain;">
                    </div>

                    <form action="<?php echo e(route('admin.settings.header-brand')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
            ...
            <div class="card" style="border:1px solid #dbe7f7; border-radius:16px; box-shadow:0 10px 24px rgba(15,23,42,0.08); overflow:hidden;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3" style="gap:0.8rem;">
                        ...
                        <span class="badge" style="background:#e2e8f0; color:#334155; font-weight:700;"><?php echo e($items->count()); ?> principales</span>
                    </div>

                    <?php if($items->count()): ?>
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('admin.crud.menu_items.partials.tree_node', ['item' => $item, 'level' => 0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\crud\menu_items\index.blade.php ENDPATH**/ ?>