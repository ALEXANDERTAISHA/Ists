...
<?php endif; ?>
                ...
                <!-- Navigation Links -->
                <!-- Aquí puedes agregar otros enlaces de navegación si es necesario -->
            </div>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        <!-- Enlace a perfil eliminado porque la ruta no existe -->
...
<?php endif; ?>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <!-- Aquí puedes agregar otros enlaces de navegación responsiva si es necesario -->
...
<?php /**PATH C:\workspace\ists\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>