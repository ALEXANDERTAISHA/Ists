...
<div class="admin-content">
    ...
    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact_whatsapp_message" id="contact_whatsapp_message" class="form-control" value="<?php echo e(old('contact_whatsapp_message', $settings['contact_whatsapp_message'] ?? '')); ?>" placeholder="Hola, quiero información sobre el ISTS Sucúa">
                </div>
            </div>
        </div>
        <div class="row mt-4">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <h3>📚 Enlaces Externos de Servicios</h3>
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Este enlace aparecerá en el menú Servicios del sitio público</small>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\settings\index.blade.php ENDPATH**/ ?>