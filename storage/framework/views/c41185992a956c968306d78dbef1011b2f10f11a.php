...
<div class="d-flex justify-content-between align-items-center mb-4" style="gap: 1rem;">
    ...
    <a href="<?php echo e(route('admin.updates.create')); ?>" class="btn-new"><i class="bi bi-plus-lg"></i> Nueva Actualización</a>
</div>
                            ...
                            <tr style="background: #fff; border-bottom: 1.5px solid #f2f2f2; box-shadow: 0 1px 4px rgba(0,158,96,0.04);">
                                ...
                                <td>
                                    <div class="d-flex flex-row align-items-center gap-2">
                                        <a href="<?php echo e(route('admin.updates.edit', $update->id)); ?>" class="btn btn-edit btn-sm" title="Editar"><i class="bi bi-pencil-square"></i> Editar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\updates\index.blade.php ENDPATH**/ ?>