        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.autoridades.update', $autoridad)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="categoria" id="categoria" class="form-control" value="<?php echo e(old('categoria', $autoridad->categoria)); ?>" placeholder="Ej: Directivos, OCS">
                </div>
                    ...
                    <?php if($autoridad->foto_path): ?>
                        ...
                        <div class="mb-2">
                            ...
                            <div style="font-size:12px;color:#b00;background:#fff;padding:2px 6px;border-radius:6px;margin-bottom:4px;">
                                Archivo: <?php echo e($autoridad->foto_path); ?><br>
                            ...
                            <img src="<?php echo e(asset('uploads/images/' . $autoridad->foto_path)); ?>" alt="Foto actual" style="max-width: 200px; height: auto;">
                        </div>
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($autoridad->pdf_path): ?>
                        <div class="mb-2">
                            <p>PDF actual: <a href="<?php echo e(asset('storage/' . $autoridad->pdf_path)); ?>" target="_blank" class="pdf-pro-link">Ver PDF</a></p>
                        </div>
                    <?php endif; ?>
                    <div class="custom-file-upload">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\autoridades\edit.blade.php ENDPATH**/ ?>