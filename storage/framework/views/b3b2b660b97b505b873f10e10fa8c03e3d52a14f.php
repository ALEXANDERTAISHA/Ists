    ...
    <div class="container" style="position:relative; z-index:1;">
        <div class="careers-hero-card">
            ...
            <div class="careers-hero-meta">
                <div class="careers-meta-box">
                    <strong><?php echo e($careers->count()); ?></strong>
        ...
        <div class="careers-grid-premium">
            <?php $__empty_1 = true; $__currentLoopData = $careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                ?>
                <a href="<?php echo e(route('career.show', $career->slug ?? $career->id)); ?>" class="career-premium-card career-premium-card-link" style="text-decoration:none;color:inherit;">
                    ...
                    <div class="career-premium-body">
                        <h2><?php echo e($career->name); ?></h2>
                        <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags($career->description ?: 'Conoce el plan académico y el perfil de salida de esta carrera.'), 145)); ?></p>
