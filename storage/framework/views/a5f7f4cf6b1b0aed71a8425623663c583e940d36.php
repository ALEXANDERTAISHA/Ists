        ...
        <div class="admin-header-content">
            ...
            <nav class="admin-nav">
                <ul class="admin-nav-menu">
                    <li><a href="<?php echo e(url('/admin/dashboard')); ?>" class="active"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                    ...
                    <li><a href="<?php echo e(url('/admin/leadership')); ?>"><i class="bi bi-person-badge"></i> Equipo</a></li>
                    <li><a href="<?php echo e(url('/admin/users')); ?>"><i class="bi bi-people"></i> Usuarios</a></li>
            ...
            <div class="admin-user-menu">
                <div class="user-info">
                    ...
                    <div class="user-dropdown">
                        <a href="<?php echo e(route('admin.profile')); ?>"><i class="bi bi-person-circle"></i> Perfil</a>
                        <a href="<?php echo e(route('password.confirm')); ?>"><i class="bi bi-key"></i> Cambiar Contraseña</a>
    ...
    <!-- Gestión de Contenido - Cajas Cuadradas -->
        <div class="quick-actions" id="gestion-contenidos">
            ...
            <div class="actions-grid">
                ...
                <a href="<?php echo e(route('admin.documentos.index')); ?>" class="action-card">
                    <div class="action-icon"><i class="bi bi-folder2-open"></i></div>
                    <h3>Documentos</h3>
                    <p><?php echo e($documentosCount ?? 0); ?> documentos</p>
                </a>
                ...
                <a href="<?php echo e(route('admin.menu-items.index')); ?>" class="action-card" style="background: linear-gradient(135deg, #e8f0ff 0%, #d7e7ff 100%); border: 2px solid #3b82f6; box-shadow: 0 10px 24px rgba(59,130,246,0.15);">
