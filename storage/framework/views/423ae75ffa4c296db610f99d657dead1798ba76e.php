    ...
    <section class="hero-section p-0 m-0" style="position:relative; min-height:calc(100vh - var(--public-header-height, 88px)); height:calc(100vh - var(--public-header-height, 88px)); overflow:hidden; margin-top:0; margin-bottom:0;">
        ...
        <section class="gac-section">
            <div class="container" style="position:relative;z-index:1;">
                ...
                <?php if($gacetaItems->count()): ?>
                <div class="gac-layout">
                    <?php $__currentLoopData = $gacetaItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <a href="<?php echo e($getGacetaUrl($n)); ?>" class="gac-card">
                            <div class="gac-card-img-wrap">
                                <?php if($cardImg): ?>
                                    <img src="<?php echo e($cardImg); ?>" alt="<?php echo e($n->title); ?>" class="gac-card-img">
                                <?php else: ?>
                            ...
                            <div class="gac-card-body">
                                <div class="gac-card-meta">
                                    ...
                                    <?php if($cardDate): ?><span class="gac-card-date"><?php echo e($cardDate); ?></span><?php endif; ?>
                                </div>
                                <h3 class="gac-card-title"><?php echo e($n->title); ?></h3>
                                <p class="gac-card-excerpt"><?php echo e(\Illuminate\Support\Str::limit(strip_tags(html_entity_decode($n->summary)), 105)); ?></p>
