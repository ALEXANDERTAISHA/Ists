...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.autoridades.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo e(old('cargo')); ?>" placeholder="Ej: Rector, Vicerrector" required>
                </div>

                <div class="form-group">
                    <label for="categoria">Categoría</label>
                    <input type="text" name="categoria" id="categoria" class="form-control" value="<?php echo e(old('categoria')); ?>" placeholder="Ej: Directivos, OCS">
                </div>

                <div class="form-group">
                    <label for="biografia">Biografía (Opcional)</label>
                    <textarea name="biografia" id="biografia" class="form-control tinymce-editor" rows="10"><?php echo e(old('biografia')); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="orden" id="orden" class="form-control" value="<?php echo e(old('orden', 0)); ?>" required>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\autoridades\create.blade.php ENDPATH**/ ?>