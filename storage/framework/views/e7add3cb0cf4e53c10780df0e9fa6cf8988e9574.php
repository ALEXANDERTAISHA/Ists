...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" style="margin-top:100px;">
    <div class="p-6 text-gray-900">
        <div class="career-title-container text-center" style="margin-bottom:2.5rem;">
            <h1 class="text-4xl font-bold mb-6"><?php echo e($title); ?></h1>
        </div>
        ...
        <div style="display: flex; gap: 2rem; align-items: flex-start; flex-wrap: wrap;">
            <div style="flex: 0 0 320px; max-width: 320px; background: #f6f6f6; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 1rem; display: flex; justify-content: center; align-items: center; width: 100%;">
                <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($title); ?>" style="max-width: 100%; max-height: 260px; border-radius: 8px; object-fit: cover;">
            </div>
            <div style="flex: 1; background: #fff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); padding: 1.5rem;">
                <p style="font-size:1.15rem; color:#222; margin-bottom:1rem;">
                    <?php echo e($firstItem['description'] ?? 'Consulta y descarga documentos organizados por carpetas y subcarpetas.'); ?>
            ...
            <?php else: ?>
                <div class="transparency-level-grid">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(!empty($item['file_url']) || !empty($item['url'])): ?>
                        <a href="<?php echo e($cardHref); ?>" target="<?php echo e($cardTarget); ?>" class="transparency-level-card pdf-card-premium">
                            ...
                            <div class="pdf-card-premium-title"><?php echo e($item['title']); ?></div>
                        </a>
                        <?php else: ?>
                        <a href="<?php echo e($cardHref); ?>" target="<?php echo e($cardTarget); ?>" class="transparency-level-card">
                            <div class="level-card-head">
                                <h3 class="level-card-title"><?php echo e($item['title']); ?></h3>
                            </div>
                            <div class="level-card-body">
                                <?php if(!empty($item['description'])): ?>
                                    <p class="level-card-description"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($item['description']), 120)); ?></p>
                                <?php endif; ?>
                            </div>
                        </a>
                        <?php endif; ?>
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\public\transparency\index.blade.php ENDPATH**/ ?>