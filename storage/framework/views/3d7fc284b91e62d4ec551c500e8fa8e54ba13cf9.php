    ...
    <div class="news-page-shell">
        ...
        <?php else: ?>
            <div class="news-grid">
                <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="news-card">
                        <div class="news-thumb-frame">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('storage/uploads/images/placeholder.jpg')); ?>" alt="<?php echo e($n->title); ?>">
                            <?php endif; ?>
                        </div>
                        <div class="news-content">
                            <span class="news-category" style="background:linear-gradient(135deg,#10b981,#14b8a6); color:#fff;"><?php echo e(ucfirst($n->category ?? 'Noticias')); ?></span>
                            <h3 class="news-card-title"><?php echo e($n->title); ?></h3>
                            <div class="news-meta">
                                <span class="news-meta-dot"></span>
                                <span><?php echo e(optional(\Carbon\Carbon::parse($n->published_at ?? null))->format('d/m/Y')); ?></span>
                            </div>
                            <p class="news-excerpt"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($n->summary), 145)); ?></p>
                            <a href="<?php echo e(route('noticias.show', $n->slug)); ?>" class="news-read-more">
                ...
                <?php if(isset($eventNews)): ?>
                    <?php $__currentLoopData = $eventNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="news-card">
                            <div class="news-thumb-frame">
                                <?php if($event->images->count()): ?>
                                    <img src="<?php echo e(asset('storage/' . ltrim($event->images->first()->image_path, '/'))); ?>" alt="<?php echo e($event->title); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('storage/uploads/images/placeholder.jpg')); ?>" alt="<?php echo e($event->title); ?>">
                                <?php endif; ?>
                            </div>
                            <div class="news-content">
                                <span class="news-category" style="background:linear-gradient(135deg,#2563eb,#3b82f6); color:#fff;">Evento pasado</span>
                                <h3 class="news-card-title"><?php echo e($event->title); ?></h3>
                                <div class="news-meta">
                                    <span class="news-meta-dot"></span>
                                    <span><?php echo e(optional($event->date)->format('d/m/Y')); ?></span>
                                </div>
                                <p class="news-excerpt"><?php echo e(\Illuminate\Support\Str::limit(strip_tags(html_entity_decode($event->description)), 145)); ?></p>
                                <a href="<?php echo e(route('public.events.show', $event->id)); ?>" class="news-read-more">
                                    Ver detalles
                                    <span class="news-read-more-arrow">↗</span>
                                </a>
                            </div>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\public\news\index.blade.php ENDPATH**/ ?>