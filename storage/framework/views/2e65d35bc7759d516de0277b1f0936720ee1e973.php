                        ...
                        <?php $__currentLoopData = $careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <article class="career-card">
                                <div class="career-image">
                                    <?php if($imgSrc): ?>
                                        <img src="<?php echo e($imgSrc); ?>" alt="<?php echo e($career->name); ?>" loading="lazy">
                                    <?php else: ?>
                                        <div class="career-fallback"><?php echo e(\Illuminate\Support\Str::limit($career->name, 18, '')); ?></div>
                                    <?php endif; ?>
                                </div>

                                <div class="career-content">
                                    <h3 class="career-title"><?php echo e($career->name); ?></h3>

                                    <p class="career-description">
                                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($career->description ?: 'Formación tecnológica orientada a resultados reales en el entorno profesional.'), 120)); ?>
                                    ...
                                    <?php if($career->coordinator): ?>
                                        <div class="career-coordinator">
                                            ...
                                            <?php if($career->coordinator_email): ?>
                                                <a href="mailto:<?php echo e($career->coordinator_email); ?>" class="coordinator-email">
                                                    <?php echo e($career->coordinator_email); ?>
                                    ...
                                    <a href="<?php echo e(route('career.show', $career->slug)); ?>" class="btn-read-more">
                                        Ver carrera
                                    </a>
                                </div>
                            </article>
...
<?php /**PATH C:\workspace\ists\resources\views\public\coordinaciones.blade.php ENDPATH**/ ?>