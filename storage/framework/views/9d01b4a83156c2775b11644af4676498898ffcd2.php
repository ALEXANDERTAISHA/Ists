        ...
        <div class="row mt-5">
            <div class="col-md-8 offset-md-2">
                <div class="card p-4 shadow-sm">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary mt-3">Contactar para Visita</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\public\visitar.blade.php ENDPATH**/ ?>