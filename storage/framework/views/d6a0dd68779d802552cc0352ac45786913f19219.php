...
<div class="card" style="border-radius: 18px; box-shadow: 0 2px 16px rgba(0,158,96,0.10); margin-top: 2.5rem;">
    <div class="card-body p-5">
        <div class="mb-4 d-flex flex-column flex-md-row align-items-center justify-content-between" style="gap:1.2rem;">
            ...
            <a href="<?php echo e(route('admin.academic-calendar.create')); ?>" class="btn-new"><i class="bi bi-plus-lg"></i> Crear Calendario</a>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr style="background: #fff;">
                            ...
                            <td style="display:flex; gap:0.5em;">
                                    <a href="<?php echo e(route('admin.academic-calendar.edit', $event)); ?>" class="btn btn-edit btn-sm"><i class="bi bi-pencil-square"></i> Editar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\academic_calendar\index.blade.php ENDPATH**/ ?>