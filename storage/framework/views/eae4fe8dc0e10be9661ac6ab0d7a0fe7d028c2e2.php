...
<section class="career-detail-page">
    <div class="career-hero" <?php if($heroImage): ?> style="background-image: url('<?php echo e($heroImage); ?>')" <?php endif; ?>>
        <div class="career-hero-overlay"></div>
        <div class="container career-hero-content">
            <a href="<?php echo e(url('/carreras')); ?>" class="career-back-link">Volver a carreras</a>
            <h1><?php echo e($career->name); ?></h1>
            <p><?php echo e($career->description ?: 'Conoce todos los detalles académicos y el perfil de formación de esta carrera.'); ?></p>
        </div>
    </div>
            ...
            <div class="career-main-col">
                <article class="career-panel">
                    ...
                    <div class="career-panel-body">
                        <div class="career-copy"><?php echo $career->full_description ?: '<p>Pronto publicaremos el detalle completo de esta carrera.</p>'; ?></div>
                        <?php if($heroImage): ?>
                            <img src="<?php echo e($heroImage); ?>" alt="<?php echo e($career->name); ?>" class="career-image-card">
                        <?php endif; ?>
                    </div>
                </article>
                ...
                <article class="career-panel career-panel--alt">
                    ...
                    <div class="career-panel-body career-panel-body--reverse">
                        <div class="career-copy"><?php echo $career->professional_profile ?: '<p>Estamos preparando el perfil profesional detallado para esta carrera.</p>'; ?></div>
                        <?php if($secondaryImage): ?>
                            <img src="<?php echo e($secondaryImage); ?>" alt="Perfil <?php echo e($career->name); ?>" class="career-image-card">
                ...
                <div class="career-side-card">
                    ...
                    <?php if($career->coordinator): ?>
                        <div class="career-side-item">
                            ...
                            <strong><?php echo e($career->coordinator); ?></strong>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($career->coordinator_email): ?>
                        <div class="career-side-item">
                            <span>Contacto</span>
                            <a href="mailto:<?php echo e($career->coordinator_email); ?>"><?php echo e($career->coordinator_email); ?></a>
                        </div>
                    <?php endif; ?>

                    <?php if($pdfUrl): ?>
                        <a href="<?php echo e($pdfUrl); ?>" target="_blank" rel="noopener noreferrer" class="career-pdf-cta" aria-label="Abrir malla curricular en PDF">
                            ...
                            <span class="career-pdf-cta__text">
                                ...
                                <?php if($pdfUpdatedLabel || $pdfSizeLabel): ?>
                                    <em>
                                        <?php if($pdfUpdatedLabel): ?>
                                            Actualizado <?php echo e($pdfUpdatedLabel); ?>
                    ...
                    <a href="<?php echo e(url('/carreras')); ?>" class="career-outline-cta">Explorar más carreras</a>
                </div>
            </aside>
        </div>
    </div>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views/public/career_detail.blade.php ENDPATH**/ ?>