    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('autoridades')); ?>">Autoridades</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo e($autoridad->nombre); ?></li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                <?php if($autoridad->foto_url): ?>
                    <img src="<?php echo e($autoridad->foto_url); ?>" class="img-fluid rounded-circle mb-3" alt="Foto de <?php echo e($autoridad->nombre); ?>" style="max-width: 250px; height: auto; object-fit: cover;">
                <?php else: ?>
                    <img src="<?php echo e(asset('images/default_avatar.png')); ?>" class="img-fluid rounded-circle mb-3" alt="Foto por defecto" style="max-width: 250px; height: auto; object-fit: cover;">
                <?php endif; ?>
                <h2 class="mt-3"><?php echo e($autoridad->nombre); ?></h2>
                <h4 class="text-muted"><?php echo e($autoridad->cargo); ?></h4>
                <p class="text-muted">Categoría: <?php echo e($autoridad->categoria); ?></p>
                    ...
                    <div class="card shadow-sm p-4">
                        ...
                        <?php if($autoridad->biografia): ?>
                            <div class="biography-content">
                                <?php echo $autoridad->biografia; ?>

                            </div>
                        <?php else: ?>
                            <p>No hay biografía disponible para <?php echo e($autoridad->nombre); ?>.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('public.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\public\autoridades\show.blade.php ENDPATH**/ ?>