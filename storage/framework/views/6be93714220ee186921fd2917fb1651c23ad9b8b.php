...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            ?>
                            <div id="imagePreviewWrap1" class="mb-2 career-preview-frame <?php echo e($img1Ok ? '' : 'd-none'); ?>">
                                <img id="imagePreview1" src="<?php echo e($img1Ok ? asset('storage/' . ltrim($career->image_path, '/')) : ''); ?>" alt="<?php echo e($career->name); ?>" class="career-preview-img">
                            </div>
                            <div id="imageEmpty1" class="mb-2 career-preview-empty <?php echo e($img1Ok ? 'd-none' : ''); ?>">Sin imagen principal</div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            ?>
                            <div id="imagePreviewWrap2" class="mb-2 career-preview-frame <?php echo e($img2Ok ? '' : 'd-none'); ?>">
                                <img id="imagePreview2" src="<?php echo e($img2Ok ? asset('storage/' . ltrim($career->image_path_2, '/')) : ''); ?>" alt="Imagen 2 - <?php echo e($career->name); ?>" class="career-preview-img">
                            </div>
                            <div id="imageEmpty2" class="mb-2 career-preview-empty <?php echo e($img2Ok ? 'd-none' : ''); ?>">Sin imagen secundaria</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\workspace\ists\resources\views\admin\careers\edit.blade.php ENDPATH**/ ?>