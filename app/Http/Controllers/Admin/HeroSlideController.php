...
class HeroSlideController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $path = Storage::disk('public')->putFile('uploads/images', $file);
    ...
    private function deleteSlideImage(?string $imagePath): void
    {
        if (empty($imagePath)) {
            return;
        }
        ...
        Storage::disk('public')->delete('uploads/images/' . $path);
    }
}
