...
class UpdateCampusItems extends Command
{
     ...
     * @var string
     */
    protected $description = 'Actualizar y recargar los servicios institucionales';
    ...
    {
        $this->info('Limpiando la tabla de servicios...');
        CampusItem::truncate();
        ...
        $this->info('Servicios actualizados correctamente.');
