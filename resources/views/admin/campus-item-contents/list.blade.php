...
<div class="admin-content">
    <h2>Contenidos del servicio {{ $campusItem->title }}</h2>
    <a href="{{ route('admin.campus-items.contents.create', $campusItem) }}" class="btn btn-primary mb-3">Crear nuevo contenido del servicio</a>
    @if($contents->count() === 0)
