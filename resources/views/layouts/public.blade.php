...
<body class="public-sticky-footer">
    ...
    @if(isset($popup) && $popup && \Route::currentRouteName() === 'home')
        ...
        <div id="popupModal" class="home-popup-overlay" role="dialog" aria-modal="true" aria-label="PopUp destacado">
            <div class="home-popup-dialog" role="document">
                ...
                @if($popup->link)
                    <a href="{{ $popup->link }}" target="_blank" rel="noopener" class="home-popup-link">
                        <div class="home-popup-media">
                            <img src="{{ asset('storage/' . $popup->image_path) }}" alt="PopUp destacado ISTS">
                        </div>
                    </a>
                @else
                    <div class="home-popup-media">
                ...
                @endif
                @if($popup->message)
                    <p class="home-popup-caption">{{ $popup->message }}</p>
                @endif
            </div>
        </div>
        <script>
    ...
    <script src="{{ asset('js/chatbot.js') }}?v={{ time() }}" defer></script>
