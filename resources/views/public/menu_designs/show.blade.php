            ...
            <div class="menu-hero-content">
                ...
                <div class="menu-hero-metrics" aria-label="Resumen de contenidos">
                    <div class="menu-hero-metric">
                        <span class="menu-hero-number">{{ $folderCount }}</span>
                        <span class="menu-hero-label">Carpetas</span>
                    </div>
                    <div class="menu-hero-metric">
                        <span class="menu-hero-number">{{ $documentCount }}</span>
                ...
                @if($mainDesign->main_description)
                    <div class="main-desc-text">
                        <div class="main-desc-content">
                            <div class="main-desc-block">{!! $mainDesign->main_description !!}</div>
                        </div>
                    </div>
                @endif

                @if($mainDesign->main_image_path)
                    <div class="main-desc-img">
                        <img src="{{ asset('storage/' . ltrim($mainDesign->main_image_path, '/')) }}" alt="{{ $menuItem->title }}">
                    </div>
                @endif
            </section>
        @endif

        @if(isset($mainDesign) && $mainDesign->main_description_2)
            <section class="premium-secondary-desc-card">
                <div class="premium-secondary-desc-content">{!! $mainDesign->main_description_2 !!}</div>
            </section>
        @endif

        @if(isset($childrenWithPdfs) && $childrenWithPdfs->count())
            <section class="premium-section">
                <div class="premium-section-heading">
                    <h2 class="premium-section-title">Carpetas</h2>
                    <span class="premium-section-pill">{{ $folderCount }} carpeta(s)</span>
                </div>

                <div class="premium-folder-grid">
                    @foreach($childrenWithPdfs as $child)
                        <div class="premium-folder-grid-item">
                            <a href="{{ route('public.menu-designs.show', $child->id) }}" class="premium-folder-card">
                                ...
                                <div class="folder-title">{{ $child->title }}</div>
                                <div class="folder-count">{{ $child->visiblePdfCountRecursive() }} documento(s)</div>
                            </a>
                        </div>
                    @endforeach
                </div>
