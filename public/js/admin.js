...
function initAdminFeatures() {
    ...
    // Toggle navegación admin en móvil
    ...
    if (menuToggle && adminNav) {
        menuToggle.addEventListener("click", function () {
            ...
            document.body.style.overflow = adminNav.classList.contains("show-mobile") ? "hidden" : "";
        });

        document.addEventListener("click", function (e) {
            const isInsideHeader = e.target.closest(".admin-header-content");
            if (!isInsideHeader && adminNav.classList.contains("show-mobile")) {
